<template>
  <div style="max-width:1000px;margin:0 auto;padding:40px 32px 80px;">
    <div style="margin-bottom:36px;">
      <h1 style="font-size:40px;font-weight:800;letter-spacing:-1px;">Mon <span class="gradient-text">panier</span></h1>
    </div>

    <!-- Empty -->
    <div v-if="cart.items.length === 0" style="text-align:center;padding:80px 0;">
      <div style="font-size:64px;margin-bottom:20px;">🛒</div>
      <p style="color:#475569;font-size:16px;margin-bottom:28px;">Votre panier est vide</p>
      <RouterLink to="/shop" class="btn-primary" style="text-decoration:none;padding:12px 28px;">Explorer la boutique →</RouterLink>
    </div>
    ...
    <div v-else style="display:grid;grid-template-columns:1fr 320px;gap:28px;align-items:start;">
      ...
      <div class="card" style="padding:28px;position:sticky;top:84px;">
        <div style="font-size:16px;font-weight:700;color:#e2e8f0;margin-bottom:20px;">Résumé</div>
        ...
        <div style="display:flex;flex-direction:column;gap:12px;margin-bottom:20px;">
          ...
          <div style="display:flex;justify-content:space-between;font-size:13px;">
            <span style="color:#475569;">Livraison</span>
            <span style="color:#34d399;font-weight:600;">Gratuite</span>
          </div>
